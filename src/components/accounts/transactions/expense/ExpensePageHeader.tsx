    ...
    <div className="mb-xl">
      <nav className="mb-sm">
        <ol className="flex flex-wrap items-center gap-xs text-label-sm text-on-surface-variant">
          ...
          <li className="font-semibold text-primary">Expense</li>
        </ol>
      </nav>

      <div className="flex flex-col gap-md sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-headline-lg text-on-surface">Expense Management</h1>
          <p className="mt-xs max-w-2xl text-body-md text-on-surface-variant">
            Track and manage business expenses including operational costs, rent, 
            utilities, and other company expenditures.
          </p>
        </div>
      </div>
    </div>
